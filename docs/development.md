...
本项目已经从“核心业务链路可联调”推进到“测试环境上线前验收”阶段。正式 Taro 小程序、管理后台、后端生产化能力、发布门禁，以及 CP-33 安全接送与到离店代码闭环均已实现；当前重点是接入真实 HTTPS 测试域名、微信公众平台配置、体验版真机绑定、接送场景真机验收、备份恢复演练和小范围业务试运行。
...
- 管理后台已接入真实 API，可正式登录、维护基础数据和流程模板、配置家长与接送权限、维护非账号型授权接送人、执行引用检查、查询接送/异常等业务记录并查看审计日志。
- 教师小程序已接入工作台、今日接送、备课、教研、教学记录、流程、作业、通知/任务、消息列表和聊天详情；图片聊天与既有主链路已通过开发者工具和真机验收，CP-33 接送页仍待真机验收。
- 家长小程序已接入首页今日接送状态、接送历史、作业提交、成长、“我的”、通知/任务确认、消息列表和聊天详情；图片聊天与既有主链路已通过开发者工具和真机验收，CP-33 接送页仍待真机验收。
...
CP-21、CP-22、UI-01 至 UI-09、CP-23 至 CP-31、最新路线图定义的 CP-32 代码部分，以及重新定义的 CP-33 安全接送代码部分均已完成本地/隔离环境验证。历史 roadmap 中名为“发布流水线与回滚演练”的 CP-33 已被新路线替代，不再作为本编号任务来源。CP-32 外部项与 CP-33 真机/真实业务项仍为 `WAITING_FOR_EXTERNAL_ACCEPTANCE`；本轮完成后不自动进入 CP-34。
